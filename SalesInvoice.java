...
public class SalesInvoice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========================================================================================================");
        System.out.println(sNo1 + "\t\t" + productCode1 + "\t\t\t\t" + productName1 + "\t\t\t\t" + hsnCode1 + "\t\t" + quantity1 + "\t\t\t" + units1 + "\t\t" + rate1 + "\t" + tax1 + "%\t" + amount1);
        System.out.println(sNo2 + "\t\t" + productCode2 + "\t\t\t\t" + productName2 + "\t\t\t\t" + hsnCode2 + "\t\t" + quantity2 + "\t\t" + units2 + "\t\t" + rate2 + "\t" + tax2 + "%\t" + amount2);
        System.out.println(sNo3 + "\t\t" + productCode3 + "\t\t\t\t" + productName3 + "\t\t\t\t" + hsnCode3 + "\t\t" + quantity3 + "\t\t\t" + units3 + "\t\t" + rate3 + "\t" + tax3 + "%\t" + amount3);
        System.out.println(sNo4 + "\t\t" + productCode4 + "\t\t\t\t" + productName4 + "\t\t\t\t" + hsnCode4 + "\t\t" + quantity4 + "\t\t\t" + units4 + "\t\t" + rate4 + "\t" + tax4 + "%\t" + amount4);
        System.out.println(sNo5 + "\t\t" + productCode5 + "\t\t\t\t" + productName5 + "\t\t\t\t" + hsnCode5 + "\t\t" + quantity5 + "\t\t\t" + units5 + "\t\t" + rate5 + "\t" + tax5 + "%\t" + amount5);
        System.out.println(sNo6 + "\t\t" + productCode6 + "\t\t\t\t" + productName6 + "\t\t\t\t" + hsnCode6 + "\t\t" + quantity6 + "\t\t\t" + units6 + "\t\t" + rate6 + "\t" + tax6 + "%\t" + amount6);
        System.out.println(sNo7 + "\t\t" + productCode7 + "\t\t\t\t" + productName7 + "\t\t\t\t" + hsnCode7 + "\t\t" + quantity7 + "\t\t\t" + units7 + "\t\t" + rate7 + "\t" + tax7 + "%\t" + amount7);
        System.out.println("========================================================================================================");
        System.out.println();
